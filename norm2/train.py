...
y=MaxPooling1D(pool_size=2, strides=2)(x)
x1=BatchNormalization()(y)
x1=Dropout(0.2)(x1)
x1=Conv1D(filters=128, kernel_size=8, activation='relu',
                 kernel_initializer=initializers.he_normal())(x1)
y2=MaxPooling1D(pool_size=2, strides=2)(x1)
x2=BatchNormalization()(y2)
x2=Dropout(0.2)(x2)

y3=GRU(256, return_sequences=False, recurrent_dropout=0.2)(x2)
x3=BatchNormalization()(y3)
x3=Dropout(0.2)(x3)
...
x4=concatenate([x3,input_IrrT],axis=1)
x4=Dense(128, activation='relu')(x4)
x4=Dense(64, activation='relu')(x4)
y4=Dense(32, activation='relu')(x4)
output_m=Dense(13, kernel_regularizer=regularizers.l2(0.0015),activation='softmax',name='output_m')(x4)
